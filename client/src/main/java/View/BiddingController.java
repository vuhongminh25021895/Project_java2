...
public class BiddingController {
    ...
    private void submitBid(int bidAmount) {
        ...
        if (AuctionListController.isCurrentUserAdmin()) {
            AlertBox.display("Admin không thể đặt giá.");
            return;
        }
    ...
    private void updateBidControls() {
        ...
        boolean isOwnProduct = product != null
                && AuctionListController.getCurrentUsername() != null
                && AuctionListController.getCurrentUsername().equals(product.getSellerUsername());
        boolean isAdmin = AuctionListController.isCurrentUserAdmin();
        boolean canBid = isOpen && !isOwnProduct && !isAdmin;
        ...
        if (isAdmin) {
            txtGiaMoi.clear();
            lblGiaToiThieu.setText("Admin không thể đặt giá.");
            return;
        }
